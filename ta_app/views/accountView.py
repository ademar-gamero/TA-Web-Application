...
class accountView(View):
    ...
    def get(self,request,pk):
        ...
        return render(request,"courseList.html",{'user': account})
    ...
    def post(self,request):
        ...
        try:
            ...
            return render(request,"courseList.html",{'user': self.acc_edit,'check':val})
        val = True
        updated_acc = User.objects.get(pk=self.acc_pk)
        return render(request,"courseList.html",{'user': updated_acc })
